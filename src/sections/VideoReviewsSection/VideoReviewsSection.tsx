...
import type { VideoReviewsResponse } from "../../shared/types/videoReviews";
...
export function VideoReviewsSection() {
  const { data, loading, error } = useFetch<VideoReviewsResponse>("/mock/video_reviews.json");
      ...
      <section className={styles.section}>
        <div className={styles.container}>
          <div className={styles.headerRow}>
            <h2 className={styles.title}>Видео обзоры от DJI–Market.ru</h2>
          </div>
